...
// $route['student-form']          = 'front/maintenance';
...
$route['admin-download-allotment-all'] = "allotment/Admin/download_allotment_all";
...
// $route['admin-payment-defaulter']               = "payment/Admin/defaulter"; //16122020 @b
...
$route['print-hos-payment-invoice/(:any)/(:any)/(:any)'] = "front/print_hos_payment_invoice/$1/$2/$3";
...
$route['student_change_password']                = "Front/change_password";
$route['student-payment-dashboard'] = "front/studentPaymentDashboard";
$route['add-payment-application-fee'] = "front/addpaymentApplicationFee";//28112020
$route['student-form-done-fee/(:any)/(:any)']= 'front/studentpaymentWithAppFee/$1/$2';//30112020

// $route['hostel-seat-details-by-id/(:any)'] = "seats/Admin/hostel_seat_details_by_id/$1";//04122020

$route['student-form-reg']          = 'front/studentform'; //08122020

$route['payment-by-admin']          = 'payment/Admin/paymentByAdmin'; //21012021 @b

// @b 25012021
$route['completed-students']  = "completed_students/Admin";
