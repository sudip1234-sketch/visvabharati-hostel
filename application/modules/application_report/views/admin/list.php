<div class="" id="allotment" role="tabpanel">
  ...
  <div class="table-responsive">
    <div class="asd" style="">
        <form name="frm" id="frm" method="get" onsubmit="return validateForm()" action="<?php echo base_url('admin-application-report'); ?>">
            <div class="form-row">
                <div class="col-md-3">
    ...
    <table id="example1" class="table table-striped" style="font-size: 14px;">
     ...
     //echo "<pre>"; print_r($all_data); die();
      ...
      foreach($all_data as $student)
      {
        ...
        $hostel_name_row = $this->ApplicationReportmodel->get_row_result('hostel', ['id' => $student->hostel_name]);
      }else{
