                  ...
                  <table id="example1"  class="table table-striped" style="font-size: 14px;">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Mess Start Month</th>
                        <th scope="col">Mess End Month</th>
                        <th scope="col">-</th>
                      ...
                      <?php if(!empty($all_data)){
                          ...
                          { //echo "<pre>"; print_r($ad); die; ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo date('j M Y',strtotime($ad->plan_month_start)); ?></td>

                                <td><?php echo date('j M Y',strtotime($ad->plan_month_end)); ?></td>
                                ...
                                <td> 
                                <a href="#" name="edit_ad" class="edit_button btn btn-secondary btn-sm" ad_id="<?php echo $ad->id; ?>" data-toggle="modal" data-target="#edit-admin-data">Send SMS</a>
                                </td>
                            </tr>
