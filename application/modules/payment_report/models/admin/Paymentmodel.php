...
/*
        ...
        //20022020
        if(!empty($search_year) && !empty($search_semester))
        {
            $this->db->where('YEAR(pd.payment_date)', $search_year);
            // if($search_semester == 'Jul-Dec') {
            //     $this->db->like('pd.plan_month ', 'July-Dec');
            // }
            $this->db->like('pd.plan_month ', $search_semester);
        }
