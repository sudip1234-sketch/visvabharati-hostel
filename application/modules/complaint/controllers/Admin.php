...
class Admin extends MX_Controller {
    ...
    public function index() {
        ...
        $this->middle = 'complaint/admin/list';
        $this->admin_layout();
    }
      ...
      /*  echo "<pre>";
        ...
        if($this->input->post())
        {
           ...
           /* $this->form_validation->set_rules('full_name', 'Full Name', 'trim|required');
            ...
            $redirect = base_url('admin-complaint-list');
            redirect($redirect);
           /* }*/
        ...
        $this->layouts->render('complaint/admin/form',$data , 'admin');
        }
    }
    ...
    public function details() {
        ...
        $data = $this->Complaintmodel->get_row_data( $id);
        

        if(!empty($data))
        {
            $flg = $this->Complaintmodel->readstatus();
      ...
      /**
     * Read Status Change function of User module
     *
     * @access  public
     * @param   id
     * @return  success of failure of status change
