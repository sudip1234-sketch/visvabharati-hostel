...
<div id="edit_student_info">
    <form method="post" action="<?php echo base_url('admin-update-student-info') ."/" . $student->id; ?>" name="add-form" id="editformstd" enctype="multipart/form-data">
                ...
                <div class="col-md-9">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input  type="text" class="form-control" name="student_id" id="edit_student_id" placeholder="Enter Student Id." value="<?php echo $student->student_id; ?>" >
                        </div>
                        <div class="form-group col-md-6">
                            <label>Full Name</label>
                            <input type="text" class="form-control" name="full_name" id="edit_full_name" placeholder="Enter Full Name" value="<?php echo $student->full_name; ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control datepicker" name="date_of_admission" 
                                id="edit_date_of_allotment1" placeholder="Select date"
                                value="<?php echo date_format(date_create($student->date_of_allotment), "m/d/Y"); ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Allotment Semester </label>
                            <select class="custom-select" name="semester" id="edit_semester" >
                                <?php
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-5" style="float: left;">
                                <select class="custom-select" name="vacating_month" id="edit_vacating_month" >
                                    <?php
                            ...
                            <div class="col-md-6" style="float: left;">
                                <input class="form-control" name="vacating_year" id="edit_vacating_year1" placeholder="Vacating Year" value="<?php echo $student->vacating_year ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="aadhar_card_no" id="edit_aadhar_card_no" placeholder="Enter Aadhar card no." value="<?php echo $student->identity_document ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label>State</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" id="caste_type_4" name="caste_type" class="edit_caste form-check-input" value="OBC" <?php if($student->caste_type == "general") echo "OBC"; ?> >
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="nationality_type" id="edit_nationality_type">
                            <option id="nationality_type_indian" value="indian" <?php if($student->nationality_type == "indian") echo "selected"; ?>>Indian</option>
                            <option id="nationality_type_foreign" value="foreign" <?php if($student->nationality_type != "indian") echo "selected"; ?>>Other Nations</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group" id="div_obtain_marks_type">
                        <label>Obtain Marks Type</label><br>
                            <?php if($student->cgpa != 0){ ?>
                                <label class="custom-control-label">CGPA</label>
                            <input readonly type="text" class="form-control" name="guardian_address" id="edit_guardian_address" placeholder="Enter Guardian address" value="<?php echo $student->cgpa; ?>">
                               <?php } ?>
                            <?php if($student->best_of_five != 0){ ?>
                                <label class="custom-control-label" >Best Of 5</label>
                            <input readonly type="text" class="form-control" name="guardian_address" id="edit_guardian_address" placeholder="Enter Guardian address" value="<?php echo $student->best_of_five; ?>">
                            <?php    } ?>
        ...
        <div class="modal-footer">
            ...
            <input type="hidden" class="form-control" name="distance_score" id="" value="<?php echo $student->distance_score; ?>" placeholder="Enter distance score (calculated)" disabled>
            <input type="hidden" id="" name="distance_score_validation" value="<?php echo $student->distance_score; ?>">
            <input type="hidden" class="form-control" name="final_score" id="" value="<?php echo $student->final_score; ?>" placeholder="Final Exam Score" disabled>
            <input type="hidden" id="" name="final_score_validation" value="<?php echo $student->final_score; ?>">
