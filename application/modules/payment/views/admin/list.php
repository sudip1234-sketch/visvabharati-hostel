...
.asd{ background-color: #fff;
 ...
 <div class="" id="payment-status" role="tabpanel">
  <div class="row">
    <div class="col-auto">
      <h4><!-- All Payment Report --> Defaulter Payment Report</h4>
    </div>
    <div class="col">
    ...
    <!-- <div class="table-responsive"> -->
      ...
      <div class="row">
        ...
        <div  class="col-md-4">
              <div class="">
                  <label >Year</label>
                  <select class="custom-select" name="search_by_year" id="search_by_year">
                      <option value="" selected>Choose Year...</option>
                      <?php
                      
                      for($i = 2019 ; $i < 2030 ; $i++ )
                      { ?>
                      <option <?php echo (@$_GET['search_by_year'] == $i) ? "selected" : ""; ?>  value="<?php echo $i; ?>"><?php echo $i; ?></option>
                      <?php
                      }
                      ?>
                  </select>
            ...
            <div  class="col-md-4">
              <div class="">
                  ...
                  <select class="custom-select" name="search_by_semester" id="search_by_semester">
                      ...
                      <option <?php echo (@$_GET['search_by_semester'] == 'odd') ? "selected" : ""; ?> value="odd">Odd</option>
                      <option <?php echo (@$_GET['search_by_semester'] == 'even') ? "selected" : ""; ?> value="even">Even</option>
                  </select>
              </div>
            </div>
        </div>
