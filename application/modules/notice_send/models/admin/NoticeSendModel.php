 ...
 */
class NoticeSendModel extends CI_Model {
    ...
    public function load_all_data() {
        ...
        $this->db->select('st.id,st.student_id,st.contact_no');
...
/* End of file NoticeSendModel.php */
/* Location: ./application/modules/application_report/models/admin/NoticeSendModel.php */