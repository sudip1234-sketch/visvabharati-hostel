          ...
          <div class="row justify-content-center">
            <div class="col-sm-8 col-md-6 col-lg-4">
              <div class="card text-white bg-secondary login_sectn login_sectn_admin">
                ...
                <div class="card-body">
                  <form action="<?php echo base_url('admin_forgot_password'); ?>" method="post">
                    <div class="form-group">
                      <label>Admin Email Id</label>
                      <input type="email" name="reset_emailid" class="form-control" placeholder="Enter Email Id" value="">                
                    </div>                    
                    <button type="submit" class="btn btn-success">Reset Password </button>
                    &nbsp; 
                    <a href="<?php echo base_url('admin'); ?>" class="forgot-password" style="color: #fff;"><small><u>Login</u></small></a>
