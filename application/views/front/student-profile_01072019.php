                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                     ...
                     <!--  <div class="form-row">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">                         
                          <label>Semester</label>
                              <select class="custom-select inputDisabled" name="semester" id="semester"  disabled>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control inputDisabled" placeholder="Enter your VB registration Id" value="<?php echo (!empty($student_details->vb_reg_id)? $student_details->vb_reg_id:'');?>" disabled>
                        </div>
                        <div class="form-group col-md-6">
                          <label>Date of Birth</label>
                          <input class="form-control datepicker inputDisabled" id="datepicker2" placeholder="Select date" value="<?php echo (!empty($student_details->date_of_birth)? date('d/m/Y',strtotime($student_details->date_of_birth)):'');?>" disabled>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label>Aadhar No/Voter Id/Any Address Proof</label>
                          <input type="text" class="form-control inputDisabled" placeholder="Enter your Aadhar card no." value="<?php echo (!empty($student_details->aadhar_card_no)? $student_details->aadhar_card_no:'');?>" disabled>
                        </div>
                        <div class="form-group col-md-6">
                          <label>State</label>
                          <select class="custom-select inputDisabled" name="state_id" id="state_id" disabled >
                             <?php 
                                if(!empty($all_states))
                                {
                      ...
                      <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control inputDisabled" placeholder="Enter your address" value="<?php echo (!empty($student_details->address)? $student_details->address:'');?>" disabled>
                      </div>

                      <div class="form-group">
                        <label>District</label>
                        <input type="text" class="form-control inputDisabled" placeholder="Enter your district" value="<?php echo (!empty($student_details->district)? $student_details->district:'');?>" disabled>
                      </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label>City</label>
                          <input type="text" class="form-control inputDisabled" placeholder="Enter your city name" value="<?php echo (!empty($student_details->city)? $student_details->city:'');?>" disabled>
                        </div>
                        <div class="form-group col-md-6">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control inputDisabled" placeholder="Enter your gurdian name" value="<?php echo (!empty($student_details->guardian_name)? $student_details->guardian_name:'');?>" disabled>
                        </div>
                        <div class="form-group col-md-6">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control inputDisabled" placeholder="Enter your Guardian contact no." value="<?php echo (!empty($student_details->guardian_contact_no)? $student_details->guardian_contact_no:'');?>" disabled>
                        </div>
                        <div class="form-group col-md-6">
                          <label>Guardian Email Id</label>
                          <input type="text" class="form-control inputDisabled" placeholder="Enter your gurdian email id" value="<?php echo (!empty($student_details->guardian_email_id)? $student_details->guardian_email_id:'');?>" disabled>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>Guardian Address</label>
                        <input type="text" class="form-control inputDisabled" placeholder="Enter your gurdian address" value="<?php echo (!empty($student_details->guardian_address)? $student_details->guardian_address:'');?>" disabled>
                      </div>
                      <div class="form-group">
                        <label>PWD Status</label><br>
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input inputDisabled"  <?php echo ( $student_details->pwd_status == '1' ? 'checked':'');?> disabled>
                          <label class="custom-control-label" for="customRadioInline1">Yes</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input inputDisabled" <?php echo ( $student_details->pwd_status == '0' ? 'checked':'');?> disabled>
                     ...
                     <!--  <button type="submit" class="btn btn-danger" id="btn-save" style="display: none;">Save Profile</button> -->
                      ...
                      <button type="submit" class="btn btn-danger" id="btn-save">Save Profile</button>
                    </form>
                  </div>
                </div>
              </div>
...
if(@$student_details->nationality_type=='indian'){
  $room_fee_charge = $room_fee_hostel->room_fee;
}else{
  $room_fee_charge = $room_fee_hostel->room_fee_foreigner;
}

if(@$student_details->caste_type=='SC' || @$student_details->caste_type=='ST'){
  $room_fee_charge = 0;
}else{
...
if(!empty($payment_options) && empty($student_mess_fee_details))
{
...
?>
                      ...
                      <?php $roomRent = $kitchen = array();

                      $stYear = (!empty($student_details->hostel_assign_date)? date('Y',strtotime($student_details->hostel_assign_date)):'');
                      $stMonth = (!empty($student_details->hostel_assign_date)? date('m',strtotime($student_details->hostel_assign_date)):'');
                      ...
                      if(!empty($student_details->hostel_name)){ 
                       ...
                       if(!empty($roomRent)){ 
                         if($stMonth=='7' || $stMonth=='8' || $stMonth=='9'){
                          $planA = (!empty($roomRent->july_A)? $roomRent->july_A:'');
                          $planB = (!empty($roomRent->july_B)? $roomRent->july_B:'');
                          $planC = (!empty($roomRent->july_C)? $roomRent->july_C:'');

                          $planA_Month = 'July';
                          $planB_Month = 'August';
                          $planC_Month = 'September';

                        }else if($stMonth=='10' || $stMonth=='11' || $stMonth=='12'){
                          $planA = (!empty($roomRent->october_A)? $roomRent->october_A:'');
                          $planB = (!empty($roomRent->october_B)? $roomRent->october_B:'');
                          $planC = (!empty($roomRent->october_C)? $roomRent->october_C:'');


                          $planA_Month = 'October';
                          $planB_Month = 'November';
                          $planC_Month = 'December';

                        }else if($stMonth=='01' || $stMonth=='02' || $stMonth=='03'){
                          $planA = (!empty($roomRent->january_A)? $roomRent->january_A:'');
                          $planB = (!empty($roomRent->january_B)? $roomRent->january_B:'');
                          $planC = (!empty($roomRent->january_C)? $roomRent->january_C:'');

                          $planA_Month = 'January';
                          $planB_Month = 'February';
                          $planC_Month = 'March';

                        }else if($stMonth=='04' || $stMonth=='05' || $stMonth=='06'){
                          $planA = (!empty($roomRent->april_A)? $roomRent->april_A:'');
                          $planB = (!empty($roomRent->april_B)? $roomRent->april_B:'');
                          $planC = (!empty($roomRent->april_C)? $roomRent->april_C:'');
                    ...
                    <div class="form-row">
                     <div class="form-group col-md-6">
                        <label>Room Rent 3 months (₹<span id="hostel_charge"> <?php echo ((!empty($room_fee_hostel) && !empty($room_fee_charge)) ? $room_fee_charge:'0.00');?></span>X3)</label>
                        
                      </div>
                      <div class="form-group col-md-6">
                       
                        <span id="total_hostel_charge_for_3_months">₹<?php echo ((!empty($room_fee_hostel) && !empty($room_fee_charge)) ? number_format(($room_fee_charge*3),2):'0.00');?></span>
                        <input type="hidden" name="room_rent_charge" id="room_rent_charge" value="<?php echo ((!empty($room_fee_hostel) && !empty($room_fee_charge)) ? ($room_fee_charge*3):'0.00');?>" />
                      </div>
                    </div> 
                    <div class="form-row">
                     <div class="form-group col-md-6">
                        <label>From Date</label>                        
                         <input disabled class="form-control datepicker inputDisabled" id="datepicker3" name="from_date" placeholder="From date" value="<?php echo (!empty($student_details->hostel_assign_date)? date('m-d-y',strtotime($student_details->hostel_assign_date)):'');?>">

                         <input type="hidden" id="datepicker33" name="from_date1" value="<?php echo (!empty($student_details->hostel_assign_date)? date('Y-m-d',strtotime($student_details->hostel_assign_date)):'');?>">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        $qq3 = array('01','02','03');
                        $qq4 = array('04','05','06');
                        $start_month_name = (!empty($student_details->hostel_assign_date)? date('m',strtotime($student_details->hostel_assign_date)):'');

                        $month_names = array();
                        if(in_array($start_month_name, $qq1)){
                          $month_names = $qq1;
                          $end_month_date = '09-30-'.date("y");
                          $end_month_date1 = date("Y").'-09-30';
                        }else if(in_array($start_month_name, $qq2)){
                          $month_names = $qq2;
                          $end_month_date = '12-31-'.date("y");
                          $end_month_date1 = date("Y").'-12-31';
                        }else if(in_array($start_month_name, $qq3)){
                          $month_names = $qq3;
                          $end_month_date = '03-31-'.(date("y")+1);
                          $end_month_date1 = (date("y")+1).'-03-31';
                        }else if(in_array($start_month_name, $qq4)){
                          $month_names = $qq4;
                          $end_month_date = '06-30-'.(date("y")+1);
                          $end_month_date1 = (date("y")+1).'-06-30';
                        }

                        //echo "<pre>"; print_r($month_names);  die;
                        $start_month_name1 =  @$month_names[0];
                        $middle_month_name =  @$month_names[1];
                        $end_month_name =  @$month_names[2];


                        // rate 
                        $date21 = (!empty($student_details->hostel_assign_date)? date('Y-m-t',strtotime($student_details->hostel_assign_date)):'');
                        $start = new DateTime($student_details->hostel_assign_date);
                        $end = new DateTime($date21);
                        ...
                        foreach($period as $dt) {
                            $curr = $dt->format('D');
                            // substract if wednesdey or thursday
                            if ($curr == 'Wed' || $curr == 'Thur') {
                                $days--;
                            }                            
                        }
                        //echo 'days--------'.$days; die;

                        if($start_month_name=='07' || $start_month_name=='10' || $start_month_name=='01' || $start_month_name=='04'){
                          $first_fee_A = number_format((($planA / 22) * @$days),2) ;
                          $total_fee_A = (($planA / 22) * @$days) + $planA + $planA;

                          $first_fee_B = number_format((($planB / 22) * @$days),2);
                          $total_fee_B = (($planB / 22) * @$days) + $planB + $planB;

                          $first_fee_C = number_format((($planC / 22) * @$days),2);
                          $total_fee_C = (($planC / 22) * @$days) + $planC + $planC;

                          $month_details_A = $first_fee_A.'##'.$planA.'##'.$planA;
                          $month_details_B = $first_fee_B.'##'.$planB.'##'.$planB;
                          $month_details_C = $first_fee_C.'##'.$planC.'##'.$planC;


                        }else if($start_month_name=='08' || $start_month_name=='11' || $start_month_name=='02' || $start_month_name=='05'){
                          $first_fee_A = number_format((($planA / 22) * @$days),2);
                          $total_fee_A = (($planA / 22) * @$days) + $planA;

                          $first_fee_B = number_format((($planB / 22) * @$days),2);
                          $total_fee_B = (($planB / 22) * @$days) + $planB;

                          $first_fee_C = number_format((($planC / 22) * @$days),2);
                          $total_fee_C = (($planC / 22) * @$days) + $planC;

                          $month_details_A = '0'.'##'.$first_fee_A.'##'.$planA;
                          $month_details_B = '0'.'##'.$first_fee_B.'##'.$planB;
                          $month_details_C = '0'.'##'.$first_fee_C.'##'.$planC;


                        }else if($start_month_name=='09' || $start_month_name=='12' || $start_month_name=='03' || $start_month_name=='06'){
                          $first_fee_A = number_format((($planA / 22) * @$days),2);
                          $total_fee_A = (($planA / 22) * @$days);

                          $first_fee_B = number_format((($planB / 22) * @$days),2);
                          $total_fee_B = (($planB / 22) * @$days);

                          $first_fee_C = number_format((($planC / 22) * @$days),2);
                          $total_fee_C = (($planC / 22) * @$days);

                          $month_details_A = '0'.'##'.'0'.'##'.$first_fee_A;
                          $month_details_B = '0'.'##'.'0'.'##'.$first_fee_B;
                          $month_details_C = '0'.'##'.'0'.'##'.$first_fee_C;


                        }else{
                          $first_fee_A = $planA;
                          $total_fee_A = $first_fee_A;

                          $first_fee_B = $planB;
                          $total_fee_B = $first_fee_B;

                          $first_fee_C = $planC;
                          $total_fee_C = $first_fee_C ;

                          $month_details_A = $planA.'##'.$planA.'##'.$planA;
                          $month_details_B = $planB.'##'.$planB.'##'.$planB;
                          $month_details_C = $planC.'##'.$planC.'##'.$planC;
                        }

                       // echo"--". $month_details; die;


                        $plan_Months = @$planA_Month.'##'.@$planB_Month.'##'.@$planC_Month ;

                                              

                         ?>
                        <input disabled class="form-control datepicker inputDisabled" id="datepicker4" name="to_date" placeholder="To date" value="<?php echo @$end_month_date;?>">


                        <input type="hidden" id="datepicker43" name="to_date1" value="<?php echo @$end_month_date1;?>">


                        <span><small>Date Format : MM-DD-YY</small></span>

                        <input type="hidden" name="monthStart" id="monthStart" value="<?php echo @$start_month_name1;?>" />

                        <input type="hidden" name="monthMiddle" id="monthMiddle" value="<?php echo @$middle_month_name;?>" />

                        <input type="hidden" name="monthEnd" id="monthEnd" value="<?php echo @$end_month_name;?>" /> 


                        <input type="hidden" name="p_A" id="p_A" value="<?php echo @$total_fee_A;?>" />  
                        <input type="hidden" name="p_B" id="p_B" value="<?php echo @$total_fee_B;?>" />  
                        <input type="hidden" name="p_C" id="p_C" value="<?php echo @$total_fee_C;?>" />


                        <input type="hidden" name="p_A_month" id="p_A_month" value="<?php echo @$month_details_A;?>" />  
                        <input type="hidden" name="p_B_month" id="p_B_month" value="<?php echo @$month_details_B;?>" />  
                        <input type="hidden" name="p_C_month" id="p_C_month" value="<?php echo @$month_details_C;?>" />

                       <input type="hidden" name="plan_Months" id="plan_Months" value="<?php echo @$plan_Months;?>" />


                      </div>
                    </div>
                     <?php if(!empty($kitchen) && ($kitchen->kitchen=='yes')) { ?>
                     <input type="hidden" name="planYesNo" id="planYesNo" value="yes">
                     <div class="form-row">
                     <div class="form-group col-md-6">
                        <label>Mess Rent</label><br>

                          <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline21" onclick="javascript:selectPlan(1);" name="select_plan" value="A" class="custom-control-input">
                        <label class="custom-control-label" for="customRadioInline21">Plan A</label>
                        <span>&nbsp&nbsp (₹<span id="charge_for_plan_one"><?php echo @$planA;?></span>) <span class="select_plan_class"></span>  </span>
                        <input type="hidden" name="amount_for_plan_one" id="amount_for_plan_one" value="B" />
                      </div>
                      <br>
                      <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline22" onclick="javascript:selectPlan(1);" name="select_plan" value="C" class="custom-control-input">
                        <label class="custom-control-label" for="customRadioInline22">Plan B</label>
                        <span>&nbsp&nbsp (₹<span id="charge_for_plan_two"><?php echo @$planB;?></span>)<span class="select_plan_class"></span></span>
                         <input type="hidden" name="amount_for_plan_two" id="amount_for_plan_two" value="<?php echo @$planB;?>" />
                      </div>
                      <br>
                       <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline23" onclick="javascript:selectPlan(1);" name="select_plan" value="<?php echo @$planC;?>" class="custom-control-input">
                        <label class="custom-control-label" for="customRadioInline23">Plan C</label>
                        <span>&nbsp&nbsp (₹<span id="charge_for_plan_three"><?php echo @$planC;?></span>)<span class="select_plan_class"></span></span>
                        <input type="hidden" name="amount_for_plan_three" id="amount_for_plan_three" value="<?php echo @$planC;?>" />
                      </div>
                        
                      </div>
                      <div class="form-group col-md-6">
                       
                        <span id="total_plan_amount">₹0.00</span>

                        <input type="hidden" name="mess_rent_charge" id="mess_rent_charge" value="" />
                      </div>
                    </div>

                    <!-- payment month select -->

                    <div class="form-row" id="monthdetails" style="display: none;">                     
                      <div class="form-group col-md-12">                       
                        <span class="month1">Month1 : </span>
                        <span class="month1Rate">₹0.00</span>
                      </div>

                      <div class="form-group col-md-12">                       
                        <span class="month2">Month2 : </span>
                        <span class="month2Rate">₹0.00</span>
                      </div>

                      <div class="form-group col-md-12">                       
                        <span class="month3">Month3 : </span>
                        <span class="month3Rate">₹0.00</span>
                      </div>
                    ...
                    <?php }else{ ?>
                    <input type="hidden" name="planYesNo" id="planYesNo" value="no">
                     <?php } ?>
                      </div>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <form novalidate method="post" action="<?php echo base_url('add-payment'); ?>" name="add-form" id="addform" enctype="multipart/form-data"> 
                      ...
                      if(!empty($student_details->hostel_name)){ 
                       ...
                       if(!empty($roomRent1)) {
                        $amm = ($roomRent1->hostel_charge*3) + $option_amount;
                       }else{
                        $amm = 0.00;
                       }
                       ?>
                                   <span id="total_payable_amount"><?php echo ((!empty($roomRent1) && !empty($roomRent1->hostel_charge)) ? number_format($amm,2):'0.00');?></span>
                                    <input type="hidden" name="total_amount" id="total_amount" value="<?php echo ((!empty($roomRent1) && !empty($roomRent1->hostel_charge)) ? number_format(($roomRent1->hostel_charge*3),2):'0.00');?>" />
                                    <input type="hidden" name="total_paid" id="total_paid" value="<?php echo ((!empty($roomRent1) && !empty($roomRent1->hostel_charge)) ? number_format(($roomRent1->hostel_charge*3),2):'0.00');?>" />
                                    <input type="hidden" name="total_overdue" id="total_overdue" value="0" />
                                     <input type="hidden" name="new_from_date_hidden" id="new_from_date_hidden" value="" />
                                      ...
                                      <input type="hidden" name="room_value" id="room_value" value="<?php echo ((!empty($room_fee_hostel) && !empty($room_fee_charge)) ? number_format(($room_fee_charge*3),2):'0.00');?>" />
