          ...
          <div class="col-sm-12 col-md-12 profileAll" <?php if(!empty($student_details->id) && $student_details->otp_confirm==0){ ?> style="display: none;" <?php } ?>>
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="profile" role="tabpanel">
                ...
                <div class="row">
                <!-- <form method="post"> 28112020-->
                <form id="add_payment_application_fee" action="<?php echo base_url('add-payment-application-fee'); ?>" method="POST">
                  <div class="col-md-12">                    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                       <!-- <input type="submit" class="btn btn-danger" name="pay_fee" id="btn-save" value="Pay"> 28112020-->
...
//28112020
$("#add_payment_application_fee").submit(function(e){
      e.preventDefault();
      $.ajax({
