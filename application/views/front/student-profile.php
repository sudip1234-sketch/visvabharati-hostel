        ...
        <div class="row">
          <div class="col-sm-5 col-md-3">
            ...
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a <?php if (@$student_details->payment_option_show > date('Y-m-d')) { ?>   style="display: none;" <?php } ?> class="nav-link"  href="<?php echo base_url('student-payment-dashboard'); ?>" >Make Payment</a>
                     ...
                     <!--  <div class="form-row">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">                         
                          ...
                          <?php
                            //current semester
                          $ad_year = substr($student_details->student_id, -4, 2);
                            ...
                            <tr>
                             ...
                             <!--    <td> 
                                 ...
                                 <td> 
                                  ...
                                  <a target="_blank" href="<?php echo base_url().'print-hos-payment-invoice/'.$ad->id.'/'.$row_sem.'/'.$i; ?>" name="print_ad" class="edit_button btn btn-secondary btn-sm">Print</a>
                                  <?php } ?>
