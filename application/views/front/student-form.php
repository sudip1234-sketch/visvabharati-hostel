            ...
            <div class="col-sm-12 col-md-12">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="profile" role="tabpanel">
                        ...
                        <form id="addformstudent" action="<?php echo base_url('add-student-profile'); ?>" method="post">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="country_div">
                                            <label>Name of Country of Origin</label>
                                        ...
                                        <div class="form-group col-md-6" id="passport_div">
                                            <label>Passport number</label>
                                            <input type="text" class="form-control" name="passport_no" id="passport_no" placeholder="Enter Passport No." value="" >
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="passport_valid_div">
                                            <label>Passport valid till</label>
                                            <input class="form-control datepicker " name="date_of_passport_valid" id="date_of_passport_valid" placeholder="Select date">
                                            
                                        </div>
                                        <div class="form-group col-md-6" id="visa_div">
                                            <label>VISA Number</label>
                                            <input type="text" name="visa_id" id="visa_id" class="form-control" placeholder="VISA Number" value="" >
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="date_of_issue_of_VISA_div">
                                            <label>Date of Issue of VISA</label>
                                             <input class="form-control datepicker" name="date_of_issue_of_VISA" id="date_of_issue_of_VISA" placeholder="Select date">
                                        </div>
                                        <div class="form-group col-md-6" id="date_of_visa_valid_till_div">
                                            <label>VISA valid till</label>
                                            <input class="form-control datepicker" name="date_of_visa_valid_till" id="date_of_visa_valid_till" placeholder="Select date">
                                        </div>
                                    </div>
                                     <!-- Other country end -->
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="city_div">
                                            <label>City</label>
                                        ...
                                        <div class="form-group col-md-6" id="pincode_div">
                                            ...
                                            <span style="font-size: 10px;" >Example - 700104 <b style="color: #ff5050">Note: 731204 and 731235 not applied.</b></span>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="div_caste_type">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="customRadioInline17" name="caste_type" class="custom-control-input" value="EWS">
                                                <label class="custom-control-label" for="customRadioInline17">EWS</label>
                                            </div>
                                        </div>
                                    </div>
