                    ...
                    <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">                        
                        <tr>  
                            ...
                            <td style=" padding: 5px; font-size: 13px; width: 100%; text-align: right;">
                               Kindly accept Hostel <?php if($payment_details->form_type=='mess_food'){ ?>Seat Rent & Mess Charge <?php } ?> <br>
...
student for <?php if($payment_details->gender=='male'){ ?> his <?php }else{ echo "her" ; } ?> hostel accommodation.
   ...
   <p style=" font-family:'Open Sans',Arial,Helvetica,sans-serif; padding: 5px; font-size: 20px; text-align: center;"><strong>The details of rent / charges are given below :</strong></p>
    <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 11px;" width="100%" cellspacing="0" cellpadding="0" border="1" align="center">                        
                        <tr>                            
                            ...
                            <th style=" padding: 5px; font-size: 13px; font-size: 14px;">Hotel Name</th>
                         ...
                         <tr>                            
                            ...
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">
                                <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style=" padding: 5px; font-size: 13px; font-size: 13px;"><?php echo @$payment_details->HostelName ; ?> </td>                                        
                                    </tr> 
                            ...
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">
                                <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style=" padding: 5px; font-size: 13px; font-size: 13px;"><?php echo (str_replace(",", "", $payment_details->room_value)/3); ?></td>                                        
                                    </tr>                                                                     
                                </table>
                            </td>                            
                            <td  style=" padding: 5px; font-size: 13px; font-size: 13px; text-align: center; vertical-align: top;"><?php echo @$payment_details->room_value ; ?></td>
                            
                        </tr>
                        <!-- <tr>                            
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;"></td>
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">One / Two / Three / Four Seated Room</td>                            
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">Indian / Foreign</td>
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;"></td>
                        </tr> -->
                         <tr>                            
                            <th style=" padding: 5px; font-size: 13px; font-size: 14px;" valign="top">2</th>
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">
                                <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif; font-size: 11px;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                    <tr>
                                        <th align="left" style="font-size: 14px;">Kitchen Charge</th>
                                    </tr>


                                    <tr>
                                        <td><?php echo $payment_details->plan_month_type; ?></td>
                                    </tr>
                                    <?php $month_names_breakup = explode('##', $payment_details->month_names_breakup);

                                    $month_fees_breakup = explode('##', $payment_details->month_fees_breakup);
                                     
                                    for ($i=0; $i < count($month_names_breakup); $i++) { 
                                        ?>
                                        <tr>
                                        <td><?php echo $month_names_breakup[$i].' - '.$month_fees_breakup[$i];  ?></td>
                                    </tr>
                                    <?php }
                            ...
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;"><?php echo @$payment_details->plan_month_amount ; ?></td>
                            <td  style=" padding: 5px; font-size: 13px; font-size: 13px; text-align: center; vertical-align: top;"><?php echo @$payment_details->plan_month_amount ; ?></td>
                        </tr>


                        <tr>                            
                            <th style=" padding: 5px; font-size: 13px; font-size: 13px;" valign="top">3</th>
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">
                                <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style=" padding: 5px; font-size: 13px; font-size: 13px;">Other </td>                                        
                                    </tr> 
                            ...
                            <td style=" padding: 5px; font-size: 13px; font-size: 13px;">
                                <table style="border-collapse:collapse; background: #fff; font-family:'Open Sans',Arial,Helvetica,sans-serif;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style=" padding: 5px; font-size: 13px; font-size: 13px;"><?php echo $payment_details->other_value; ?></td>                                        
                                    </tr>                                                                     
                                </table>
                            </td>                            
                            <td  style=" padding: 5px; font-size: 13px; font-size: 13px; text-align: center; vertical-align: top;"><?php echo @$payment_details->other_value ; ?></td>
