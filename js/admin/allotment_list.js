...
function edit_approve(stuid, stu_hostel_name, stu_hostel_code, stu_block_no, stu_floor_no, stu_room_no, stu_bed_no) {
    if (stu_hostel_name != '' && stu_hostel_code != '' && stu_block_no != '' && stu_floor_no != '' && stu_room_no != '' && stu_bed_no != '') {
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-status-student",
            data: {
                "id": stuid
            },
            dataType: "text",
...
$("document").ready(function() {
    ...
    $("#search_by_course_only").change(function() {
        $("#frm").submit();
    });//03122020 @b

    $("#search_by_department_only").change(function() {
        $("#frm").submit();
    });//03122020 @b
    ...
    // 14122020 @b
    $('.cancel_allotment_button').click(function() {
       $("#delete-all-admin-data").on('shown.bs.modal', function() {
           $('#delete_ad_delete').click(function() {
               if($('#delete_ad_delete').val() == 'Confirm'){
               var ad_id = $('.cancel_allotment_button').attr('ad_id');
               var cancel_reason = $('#cancel_reason').val();
               // alert(ad_id);
               var saveData = $.ajax({
                   type: 'POST',
                   url: "/vb-live/admin-allotment-cancel",
                   data: {
                       "id": ad_id,
    ...
    $("#edit_hostel_name").change(function() {
        ...
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-allotment-hostel-details",
            data: {
                "id": hostel_id
            },
            dataType: "text",
        ...
        $.ajax({
            type: 'POST',
            url: "/vb-live/admin-get-hostel-blocks",
            data: {
                "hostel_id": hostel_id
            },
    ...
    $("#edit_block_no").change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: "/vb-live/admin-get-hostel-floor",
            data: {
                "hostel_id": hostel_id,
    ...
    $("#edit_floor_no").change(function() {
        ...
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-hostel-room-details",
            data: {
                "id": hostel_id,
                "block_id": block_id,
                "floor_id": floor_id
    ...
    $("#edit_room_no").change(function() {
        ...
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-hostel-bed-details",
            data: {
                "hostel_id": hostel_id,
                "block_no": block_no,
                "floor_no": floor_no,
    ...
    $('.collect_payment').click(function() {
        ...
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-collect-payment",
            data: {
                "student_id": ad_id
            },
            dataType: "text",
    ...
    $('.edit_button').click(function() {
        ...
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-allotment-student-details",
            data: {
                "id": ad_id
            },
            dataType: "text",
            success: function(resultData) {
                ...
                var saveData11 = $.ajax({
                    type: 'POST',
                    url: "/vb-live/admin-hostels-list",
                    data: {
    ...
    $('.delete_button').click(function() {
        ...
        var saveData = $.ajax({
            type: 'POST',
            url: "/vb-live/admin-student-details",
            data: {
                "id": ad_id
            },
            dataType: "text",
